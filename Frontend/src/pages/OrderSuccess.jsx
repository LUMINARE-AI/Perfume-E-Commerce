        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-sm overflow-hidden mb-6">
          ...
          <div className="bg-white/5 border-b border-white/10 px-4 md:px-6 py-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              <span className={`inline-flex items-center px-3 py-1 text-xs font-medium border ${STATUS_STYLES[order.status] || STATUS_STYLES.pending}`}>
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              ...
              <div className="text-right">
                ...
                <p className={`font-medium ${order.isPaid ? "text-green-400" : "text-yellow-400"}`}>
                  {order.isPaid ? "Paid" : isPrepaid ? "Pending Verification" : "Pay on Delivery"}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="px-4 md:px-6 py-4 border-b border-white/10">
            ...
            {hasAWB && (
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="text-white capitalize">{order.delivery.provider || "Delhivery"}</span>
                </div>
                <div className="flex justify-between">
            ...
            {!hasAWB && isPrepaid && !deliveryFailed && (
              <div className="flex items-start gap-3 p-3 bg-blue-400/5 border border-blue-400/20 text-sm">
                ...
                <div>
                  <p className="text-white font-medium">Shipment being prepared</p>
                  <p className="text-gray-400 text-xs mt-0.5">
                    Your payment was successful. Our team will create a shipment and you'll receive tracking details via email within 24 hours.
                    {expectedDelivery && (
            ...
            {!hasAWB && !isPrepaid && deliveryFailed && (
              <div className="flex items-start gap-3 p-3 bg-yellow-400/5 border border-yellow-400/20 text-sm">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-xs mt-0.5">
                    Your order is confirmed. Tracking details will be shared once the shipment is dispatched.
                    {expectedDelivery && (
                      <span className="block mt-1 text-yellow-400">
                        📦 Expected delivery by {expectedDelivery}
                      </span>
