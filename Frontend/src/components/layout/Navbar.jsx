    ...
    <>
      ...
      >
        <div className="max-w-4xl mx-auto px-6 pt-28 md:pt-36">
          ...
          <div className="relative group">
            ...
            <div className="absolute right-0 top-1/2 -translate-y-1/2">
              {searchLoading ? (
                ...
                <FiSearch
                  className="opacity-30 transition-all duration-500 group-focus-within:opacity-60"
                  style={{ color: "#D4AF37" }}
                  size={28}
                />
              )}
                    ...
                    {searchResults.map((product, idx) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          {product.brand && (
                            <p className="text-[10px] text-[#D4AF37]/70 uppercase tracking-wider mb-0.5">
                              {product.brand}
                            </p>
                          )}
          ...
          {/* Popular Searches — shown only when no input */}
          {!searchTerm.trim() && (
            <div className="mt-12">
